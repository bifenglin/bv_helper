			...
			<scroll-view :show-scrollbar="false" class="fui-ddm__scroll" scroll-y
				...
				<view>
					<view class="fui-dropdown__menu-item"
						:style="{background:background,padding:padding,paddingTop:'20rpx',paddingBottom:'20rpx',borderBottomColor:splitLine && isNvue?lineColor:'transparent'}"
...
<style scoped>
	...
	.fui-ddm__item-line::after {
		content: '';
		position: absolute;
		border-bottom: 1px solid var(--fui-color-border, #6c6c6c);
		/* #ifdef H5 */
