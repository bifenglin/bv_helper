<template>
	<view>
		<cu-custom bgColor="bg-gradual-blue" :isBack="true" >
			<block slot="backText">原创脚本</block>
		...
		<scroll-view :scroll-y="modalName==null" class="page" :class="modalName!=null?'show':''" >
			...
			<view v-for="(item, index) in items" :key="index">
				...
				<fui-row>
					<fui-col :span="8">
						<view class="fui-col__item" ><fui-tag :text="'镜头'+(index+1)" background="#0fa3fa" color="#fff" style="width: 100%;">
						</fui-tag></view>						
					</fui-col>
					<fui-col :span="8">
						<view class="fui-col__item ">
							<fui-tag background="#0fa3fa" color="#fff" style="width: 100%;">
...
<script>
	...
	export default {
		components:{
			fuiDropdownMenu,fuiIcon,fuiSection,fuiDivider,fuiTag,fuiRow,fuiCol,myFabTop,fuiButton
		},
		data() {
			return {
				modalName: null,
